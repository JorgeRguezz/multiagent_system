...
# Configuration
ASSETS_ROOT = "/home/gatv-projects/Desktop/project/playground/sam3_testing/League-X/champs"
DB_FILENAME = os.path.join(current_dir, "lol_champions_224_leagueX.nvdb")
...
def build_champion_db():
    ...
    for champion_name in tqdm(champions, desc="Processing Champions"):
        ...
        img_files = [f for f in os.listdir(champion_dir) if f.lower().endswith(('.png', '.jpg', '.jpeg'))]
        
        for img_file in img_files:
            img_path = os.path.join(champion_dir, img_file)
            ...
            try:
                ...
                # Construct Metadata
                unique_id = f"{champion_name}_{img_file}"
